...
import businessHeader from '../../data/businessHeader'

function BusinessHeader() {
  return (
    <section>
        <Container className="px-2 md:px-0">
        <h1 className='clip-path-mypolygon font-pop  my-4 md:my-8 font-normal text-lg md:text-3xl w-[150px] md:w-[280px] px-4 py-2 text-primary bg-yellow-400'>Business</h1>
                <Flex className="md:gap-x-10 flex-wrap md:justify-start justify-center">
                    <div>
                        <div className='md:w-[420px] w-[350px]'>
                            {
                               businessHeader.map((item, index) => (
                                    index == 0 &&
