...
import lifeStyleHeadNesws from '../../data/lifeStyleHeadNesws'

function LifeStyleNews() {
    return (
        <section className='mb-8'>
            <Container className="px-2 md:px-0">
                <h1 className='font-pop mb-4 mt-6 md:my-6 font-normal text-2xl md:text-3xl text-[#111111]'>Lifestyle এর আরও খবর</h1>
                <Flex className="md:gap-x-10 flex-wrap md:justify-start justify-center">
                    <div>
                        <div className='flex md:w-[1000px] gap-4 justify-center md:justify-start md:gap-5 flex-wrap'>
                            {
                                lifeStyleHeadNesws.map((item, index) => (
