...
function EnternentmentHeader() {
  return (
    <section>
        ...
        <h1 className='clip-path-mypolygon font-pop  my-4 md:my-8 font-normal text-lg md:text-2xl w-[150px] md:w-[290px] px-4 py-2 text-primary bg-yellow-400'>Entertainment</h1>
