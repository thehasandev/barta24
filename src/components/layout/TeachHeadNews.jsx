...
import teachNews from "../../data/teachHeadNews"

function TeachHeadNews() {
  return (
    <section className='mb-8'>
        <Container className="px-2 md:px-0">
        <h1 className='font-pop mb-4 mt-6 md:my-6 font-normal text-2xl md:text-3xl text-[#111111]'>Tech এর আরও খবর</h1>
