...
function TeachHeader() {
  return (
    <section>
        ...
        <h1 className='clip-path-mypolygon font-pop  my-4 md:my-8 font-normal text-lg md:text-3xl w-[150px] md:w-[180px] px-4 py-2 text-primary bg-yellow-400'>Tech</h1>
