...
function Covid19Header() {
  return (
    <section>
        ...
        <h1 className='clip-path-mypolygon font-pop  my-4 md:my-8 font-normal text-lg md:text-3xl w-[150px] md:w-[240px] px-4 py-2 text-white bg-yellow-400'>Covid-19</h1>
