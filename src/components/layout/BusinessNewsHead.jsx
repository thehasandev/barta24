...
function BusinessNewsHead() {
  return (
    <section className='mb-8'>
        <Container className="px-2 md:px-0">
        <h1 className='font-pop mb-4 mt-6 md:my-6 font-normal text-2xl text-[#111111]'>Business এর আরও খবর</h1>
...
export default BusinessNewsHead